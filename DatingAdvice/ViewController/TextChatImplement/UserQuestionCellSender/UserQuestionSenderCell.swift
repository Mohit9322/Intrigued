...
//
//  UserQuestionSenderCell.swift
//  Intrigued
//
//  Created by Shineweb-solutions on 07/03/18.
//  Copyright © 2018 daniel helled. All rights reserved.
//

import UIKit

class UserQuestionSenderCell: UITableViewCell {
    ...
    @IBOutlet weak var chatBgGrayCorner: UIImageView!
